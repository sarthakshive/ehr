...
contract Voting {
    ...
    function getProposal(uint proposalInt) public view returns (uint,string memory _string, uint, uint, uint,address[] memory _address) {
    ...
    function addProposal(string memory _title) public returns (bool) {
